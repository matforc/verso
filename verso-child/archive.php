...
?>
	...
	<div id="blogs" class="padding-100 greySection">
		...
		<div class="container item-fadeIn">
			<div class="<?php echo esc_attr($santos_main_class); ?>">
				...
				if(have_posts()) {
					...
					while( have_posts()) : the_post();
						...
						<div <?php if($blog_layout == 'masonry'){ echo 'class="'. esc_attr($blog_item_class).' col-sm-6 archive-elm"'; } ?> data-aos="">
