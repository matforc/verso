	...
	public static function admin_enqueue_scripts()
	{
		...
		if ( ! $wp_scripts->get_data( 'rwmb-media', 'data' ) )
		{
			wp_localize_script( 'rwmb-media', 'i18nRwmbMedia', array(
				'add'                => apply_filters( 'rwmb_media_add_string', _x( '+ Add Media', 'media', 'santos' ) ),
				'single'             => apply_filters( 'rwmb_media_single_files_string', _x( ' file', 'media', 'santos' ) ),
				'multiple'           => apply_filters( 'rwmb_media_multiple_files_string', _x( ' files', 'media', 'santos' ) ),
				'remove'             => apply_filters( 'rwmb_media_remove_string', _x( 'Remove', 'media', 'santos' ) ),
				'edit'               => apply_filters( 'rwmb_media_edit_string', _x( 'Edit', 'media', 'santos' ) ),
				'view'               => apply_filters( 'rwmb_media_view_string', _x( 'View', 'media', 'santos' ) ),
				'noTitle'            => _x( 'No Title', 'media', 'santos' ),
				'loadingUrl'         => RWMB_URL . 'img/loader.gif',
				'extensions'         => self::get_mime_extensions(),
				'select'             => _x( 'Select Files', 'media', 'santos' ),
				'or'                 => _x( 'or', 'media', 'santos' ),
				'uploadInstructions' => _x( 'Drop files here to upload', 'media', 'santos' ),
			) );
		}
	}
