...
class RWMB_Select_Field extends RWMB_Choice_Field
{
	...
	public static function get_select_all_html( $field )
	{
		...
		{
			return '<div class="rwmb-select-all-none">' . esc_html__( 'Select', 'santos' ) . ': <a data-type="all" href="#">' . esc_html__( 'All', 'santos' ) . '</a> | <a data-type="none" href="#">' . esc_html__( 'None', 'santos' ) . '</a></div>';
		}
		return '';
	}
}
