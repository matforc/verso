...
class RWMB_Core
{
	...
	{
		$links[] = '<a href="https://metabox.io/docs/">' . esc_html__( 'Documentation', 'santos' ) . '</a>';
		$links[] = '<a href="https://metabox.io/plugins/">' . esc_html__( 'Extensions', 'santos' ) . '</a>';
		return $links;
	}
	...
	{
		load_plugin_textdomain( 'santos', false, plugin_basename( RWMB_DIR ) . '/lang/' );
	}
