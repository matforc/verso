				...
				public function theme_setup_wizard_content($content){
					if($this->is_possible_upgrade()){
						array_unshift_assoc($content,'upgrade',array(
							'title' => __( 'Upgrade', 'santos' ),
							'description' => __( 'Upgrade Content and Settings', 'santos' ),
							'pending' => __( 'Pending.', 'santos' ),
							'installing' => __( 'Installing Updates.', 'santos' ),
							'success' => __( 'Success.', 'santos' ),
