    ...
    if ( ! class_exists( 'Redux_Validation_unique_slug' ) ) {
        class Redux_Validation_unique_slug {
            ...
            function __construct( $parent, $field, $value, $current ) {
                ...
                $this->parent                    = $parent;
                $this->field                     = $field;
                $this->field['msg']              = ( isset( $this->field['msg'] ) ) ? $this->field['msg'] : __( 'That URL slug is in use, please choose another. <code>%s</code> is open for use.', 'santos' );
            ...
            function flush_permalinks() {
				/* Remove flush_rewrite_rules because it is plugin territory at NS Theme Check */
               // flush_rewrite_rules();
            }
        } //class
    }
